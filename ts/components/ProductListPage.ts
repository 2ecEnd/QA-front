...
export class ProductListPage {
  ...
  private updateFilterFromUI() {
    this.filter = {
      ...
      cookingRequired: (document.getElementById('filter-cooking') as HTMLSelectElement)?.value || undefined,
  ...
  private resetFilterUI() {
    ...
    (document.getElementById('filter-cooking') as HTMLSelectElement).value = '';
  ...
  private renderTable(container: HTMLElement, products: Product[]) {
